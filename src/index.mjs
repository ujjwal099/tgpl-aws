...
const createPdf = async (
  ...
  try {
    ...
    <img src="${textSignature}" alt="Footer Image" style="width: 200px; padding-left: 30px; margin-left: 10px;"> <!-- Adjust the padding and margin values as per your preference -->
</div>
`
          : ""
      }
